...
%              Basic error adjustment of damping parameter
%
% Usage: lm_solver (p, kr, kx, lambda_0, lambda_max, max_iter)
%
...
function [z iter err conv] = lm_solver(p, kr, kx, lambda_0, lambda_max, max_iter)

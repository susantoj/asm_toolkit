% NR_SOLVER2 - Newton-Rhapson solver for double cage model with core losses
...
%
% Usage: nr_solver2 (p, Rs, Xr2, max_iter)
%
...
function [z iter err conv] = nr_solver2(p, Rs, Xr2, max_iter)
...
hn = 1;
hn_min = 0.0000001;
err_tol = 0.00001; % 1E-05
%err_tol = 0.0001; % 1E-04
err = 1;
iter = 0;
conv = false;
